...
def p1_project_summary_body():
    ...
    st.info(
        ...
        f"**Powdery mildew** is a common fungal disease affecting a wide range"
        f" of plant species."
        ...
        f"In cherry trees, the disease is specifically caused by "
        f"*Podosphaera clandestina*,"
        f" a parasitic fungus that significantly impacts both leaf and "
        f"fruit quality.\n\n"
    ...
    st.info(
        f"The client, **Farmy & Foods**, is currently facing a widespread "
        f"outbreak across several of its cherry tree plantations. "
        f"The existing method of disease detection involves manual leaf "
        f"inspection, which is labor-intensive and time-consuming, "
    ...
    st.write(
        ...
        f"[README](https://github.com/JedDizon/cherryleafmildewdetector"
        f"-ci-project5#readme)"
        f" file.")
